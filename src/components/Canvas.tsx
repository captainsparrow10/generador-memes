...
const Canvas = () => {
    ...
    return (
        <div className='inline-block'>
            ...
            <div>
                <div>
                    <button className='p-2 m-2 bg-black text-white rounded' onClick={addText}>Agregar Texto</button>
                    <input
                    type="text"
                ...
                <input
                    ...
                    onChange={loadImage}
                />
                <button className='p-2 m-2 bg-black text-white rounded' onClick={() => fileInputRef.current?.click()}>
                    Elegir imagen
                </button>
                </div>
                <div>
